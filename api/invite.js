// Vercel serverless function — proxies student invite calls to the Topin invite API.
// POST /api/invite
// Body: { candidates: [uid, ...], assessmentId }
// API key is stored in the TOPIN_INVITE_API_KEY Vercel env var (never exposed to the browser).
